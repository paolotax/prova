...
class HeadingComponent < ViewComponent::Base
  ...
  def initialize(level: "h1", wrapper_css: "flex flex-col gap-4 sm:flex-row sm:items-start bg-white/90 sm:justify-between px-4 py-3 mb-4 border border-gray-200 rounded-md shadow-md")
  ...
  def header_wrapper_css = @wrapper_css.presence || "flex flex-col justify-between sm:flex-row sm:items-start"
