module MCPTools
  class AppuntiList < Base
    ...
    def self.call(search: nil, stato: nil, appuntabile_type: nil, anno: nil, offset: nil, limit: nil, server_context:, **_params)
      with_current(server_context) do
        ...
        appunti = scope.order(created_at: :desc).offset((offset || 0).to_i).limit((limit || 50).to_i.clamp(1, 200))
