  ...
  def show
    ...
    respond_to do |format|
      ...
      format.pdf do
        ...
        pdf = FoglioScuolaPdf.new(Array(@import_scuola), view: view_context, tipo_stampa: tipo_stampa, con_sovrapacchi: con_sovrapacchi)
        
        filename_suffix = tipo_stampa == 'mie_adozioni' ? '_mie_adozioni' : ''
        sovrapacchi_suffix = con_sovrapacchi ? '_con_sovrapacchi' : ''
        filename = "fs#{filename_suffix}#{sovrapacchi_suffix}_#{Date.today}.pdf"
