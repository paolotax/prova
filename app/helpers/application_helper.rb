module ApplicationHelper
  ...
  BLANK_SLATES = {
    ...
    giri:      { title: "Nessun giro organizzato",  empty: "il primo giro",      icon: "add",             label: "Giro",      path: :wizard_giri_path },
    collane:   { title: "Nessuna collana creata",   empty: "la prima collana",   icon: "add",             label: "Collana",   path: :new_collana_path },
  }.freeze
