...
#   
  ...
  inflect.irregular 'pagamento', 'pagamenti'
  inflect.irregular 'registrazione', 'registrazioni'
  inflect.irregular 'importazione', 'importazioni'
  ...
  inflect.irregular 'rientro', 'rientri'
