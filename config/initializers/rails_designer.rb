RailsDesigner.configure do |config|
  ...
  config.form_builder.input_css = "block w-full resize-none text-medium font-semibold text-gray-900 bg-gray-50 border-gray-300 border-0 border-b p-3 pb-2 placeholder:text-gray-400 focus:border-indigo-600 focus:border-b-2 focus:ring-0 sm:text-sm sm:leading-6 "
