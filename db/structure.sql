...
--
-- Name: miur_import_diff_righe; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.miur_import_diff_righe (
    id bigint NOT NULL,
    import_run_id bigint NOT NULL,
    codicescuola character varying NOT NULL,
    segno character varying(1) NOT NULL,
    codiceisbn character varying,
    titolo character varying,
    disciplina character varying,
    annocorso character varying,
...
--
-- Name: miur_import_diff_righe_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.miur_import_diff_righe_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: miur_import_diff_righe_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.miur_import_diff_righe_id_seq OWNED BY public.miur_import_diff_righe.id;


--
-- Name: miur_import_diff_scuole; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.miur_import_diff_scuole (
    id bigint NOT NULL,
    import_run_id bigint NOT NULL,
    codicescuola character varying NOT NULL,
...
--
-- Name: miur_import_diff_scuole_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.miur_import_diff_scuole_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: miur_import_diff_scuole_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.miur_import_diff_scuole_id_seq OWNED BY public.miur_import_diff_scuole.id;
...
--
-- Name: miur_import_diff_righe id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.miur_import_diff_righe ALTER COLUMN id SET DEFAULT nextval('public.miur_import_diff_righe_id_seq'::regclass);


--
-- Name: miur_import_diff_scuole id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.miur_import_diff_scuole ALTER COLUMN id SET DEFAULT nextval('public.miur_import_diff_scuole_id_seq'::regclass);
...
--
-- Name: miur_import_diff_righe miur_import_diff_righe_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.miur_import_diff_righe
    ADD CONSTRAINT miur_import_diff_righe_pkey PRIMARY KEY (id);


--
-- Name: miur_import_diff_scuole miur_import_diff_scuole_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.miur_import_diff_scuole
    ADD CONSTRAINT miur_import_diff_scuole_pkey PRIMARY KEY (id);
...
--
-- Name: index_miur_import_diff_righe_on_import_run_id_and_codicescuola; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_miur_import_diff_righe_on_import_run_id_and_codicescuola ON public.miur_import_diff_righe USING btree (import_run_id, codicescuola);


--
-- Name: index_miur_import_diff_scuole_on_import_run_id_and_categoria; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_miur_import_diff_scuole_on_import_run_id_and_categoria ON public.miur_import_diff_scuole USING btree (import_run_id, categoria);


--
-- Name: index_miur_import_diff_scuole_on_import_run_id_and_provincia; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_miur_import_diff_scuole_on_import_run_id_and_provincia ON public.miur_import_diff_scuole USING btree (import_run_id, provincia);
