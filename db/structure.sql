...
--
-- Name: import_adozioni; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.import_adozioni (
    id bigint NOT NULL,
    "CODICESCUOLA" character varying,
    "ANNOCORSO" character varying,
    "SEZIONEANNO" character varying,
...
--
-- Name: import_adozioni_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.import_adozioni_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: import_adozioni_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.import_adozioni_id_seq OWNED BY public.import_adozioni.id;
...
--
-- Name: new_adozioni_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.new_adozioni_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: new_adozioni_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.new_adozioni_id_seq OWNED BY public.new_adozioni.id;


--
-- Name: new_adozioni_stg; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.new_adozioni_stg (
    id bigint DEFAULT nextval('public.new_adozioni_id_seq'::regclass) NOT NULL,
    codicescuola character varying,
    annocorso character varying,
    sezioneanno character varying,
    tipogradoscuola character varying,
...
--
-- Name: new_scuole; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.new_scuole (
    id bigint NOT NULL,
    anno_scolastico character varying,
    area_geografica character varying,
    regione character varying,
...
--
-- Name: new_scuole_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.new_scuole_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: new_scuole_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.new_scuole_id_seq OWNED BY public.new_scuole.id;
...
--
-- Name: old_adozioni; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.old_adozioni (
    id bigint NOT NULL,
    codicescuola character varying,
    annocorso character varying,
    sezioneanno character varying,
...
--
-- Name: old_adozioni_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.old_adozioni_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: old_adozioni_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.old_adozioni_id_seq OWNED BY public.old_adozioni.id;
...
--
-- Name: view_adozioni144ant_editori; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--

CREATE MATERIALIZED VIEW public.view_adozioni144ant_editori AS
...
--
-- Name: view_adozioni_elementari; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--

CREATE MATERIALIZED VIEW public.view_adozioni_elementari AS
 SELECT DISTINCT import_scuole."AREAGEOGRAFICA" AS area_geografica,
   ...
   FROM ((public.import_scuole
     JOIN public.import_adozioni ON (((import_adozioni."CODICESCUOLA")::text = (import_scuole."CODICESCUOLA")::text)))
     JOIN public.tipi_scuole ON (((import_scuole."DESCRIZIONETIPOLOGIAGRADOISTRUZIONESCUOLA")::text = (tipi_scuole.tipo)::text)))
...
ALTER TABLE ONLY public.import_adozioni ALTER COLUMN id SET DEFAULT nextval('public.import_adozioni_id_seq'::regclass);
...
ALTER TABLE ONLY public.new_adozioni ALTER COLUMN id SET DEFAULT nextval('public.new_adozioni_id_seq'::regclass);
...
ALTER TABLE ONLY public.new_scuole ALTER COLUMN id SET DEFAULT nextval('public.new_scuole_id_seq'::regclass);


--
-- Name: old_adozioni id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.old_adozioni ALTER COLUMN id SET DEFAULT nextval('public.old_adozioni_id_seq'::regclass);
...
--
-- Name: import_adozioni import_adozioni_pk; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.import_adozioni
    ADD CONSTRAINT import_adozioni_pk UNIQUE ("CODICESCUOLA", "ANNOCORSO", "SEZIONEANNO", "TIPOGRADOSCUOLA", "COMBINAZIONE", "CODICEISBN", "NUOVAADOZ", "DAACQUIST", "CONSIGLIATO");


--
-- Name: import_adozioni import_adozioni_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.import_adozioni
    ADD CONSTRAINT import_adozioni_pkey PRIMARY KEY (id);
...
--
-- Name: new_adozioni new_adozioni_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.new_adozioni
    ADD CONSTRAINT new_adozioni_pkey PRIMARY KEY (id);


--
-- Name: new_scuole new_scuole_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.new_scuole
    ADD CONSTRAINT new_scuole_pkey PRIMARY KEY (id);
...
--
-- Name: old_adozioni old_adozioni_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.old_adozioni
    ADD CONSTRAINT old_adozioni_pkey PRIMARY KEY (id);
...
--
-- Name: idx_import_adoz_ee; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_import_adoz_ee ON public.import_adozioni USING btree ("CODICESCUOLA") INCLUDE ("EDITORE", "ANNOCORSO", "DISCIPLINA") WHERE (("TIPOGRADOSCUOLA")::text = 'EE'::text);


--
-- Name: idx_import_adozioni_disc_anno_tg; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_import_adozioni_disc_anno_tg ON public.import_adozioni USING btree ("DISCIPLINA", "ANNOCORSO", "TIPOGRADOSCUOLA");
...
--
-- Name: idx_new_adoz_ee; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_new_adoz_ee ON public.new_adozioni USING btree (codicescuola) INCLUDE (editore, annocorso, disciplina) WHERE ((tipogradoscuola)::text = 'EE'::text);


--
-- Name: idx_new_adozioni_codicescuola; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_new_adozioni_codicescuola ON public.new_adozioni USING btree (codicescuola);


--
-- Name: idx_new_adozioni_disc_anno_tg; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_new_adozioni_disc_anno_tg ON public.new_adozioni USING btree (disciplina, annocorso, tipogradoscuola);


--
-- Name: idx_new_scuole_cod; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_new_scuole_cod ON public.new_scuole USING btree (codice_scuola) INCLUDE (regione, provincia);


--
-- Name: idx_new_scuole_tipo; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_new_scuole_tipo ON public.new_scuole USING btree (tipo_scuola);
...
--
-- Name: idx_on_provincia_classe_disciplina_titolo_ddcaa2b4ab; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_on_provincia_classe_disciplina_titolo_ddcaa2b4ab ON public.view_adozioni_elementari USING btree (provincia, classe, disciplina, titolo);
...
--
-- Name: index_import_adozioni_on_DISCIPLINA; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "index_import_adozioni_on_DISCIPLINA" ON public.import_adozioni USING btree ("DISCIPLINA");


--
-- Name: index_import_adozioni_on_EDITORE; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "index_import_adozioni_on_EDITORE" ON public.import_adozioni USING btree ("EDITORE");


--
-- Name: index_import_adozioni_on_TITOLO; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "index_import_adozioni_on_TITOLO" ON public.import_adozioni USING btree ("TITOLO");
...
--
-- Name: index_new_adozioni_on_classe; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_new_adozioni_on_classe ON public.new_adozioni USING btree (anno_scolastico, codicescuola, annocorso, sezioneanno, combinazione, codiceisbn, disciplina);


--
-- Name: index_new_scuole_on_codice_scuola; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_new_scuole_on_codice_scuola ON public.new_scuole USING btree (anno_scolastico, codice_scuola);
...
--
-- Name: index_old_adozioni_on_classe; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_old_adozioni_on_classe ON public.old_adozioni USING btree (anno_scolastico, codicescuola, annocorso, sezioneanno, combinazione, codiceisbn);


--
-- Name: index_old_adozioni_on_import_scuola_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_old_adozioni_on_import_scuola_id ON public.old_adozioni USING btree (import_scuola_id);
...
--
-- Name: index_view_adozioni144ant_editori_on_editore; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_view_adozioni144ant_editori_on_editore ON public.view_adozioni144ant_editori USING btree (editore);


--
-- Name: index_view_adozioni144ant_editori_on_provincia_and_editore; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_view_adozioni144ant_editori_on_provincia_and_editore ON public.view_adozioni144ant_editori USING btree (provincia, editore);


--
-- Name: index_view_adozioni_elementari_on_isbn; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_view_adozioni_elementari_on_isbn ON public.view_adozioni_elementari USING btree (isbn);


--
-- Name: index_view_adozioni_elementari_on_provincia; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_view_adozioni_elementari_on_provincia ON public.view_adozioni_elementari USING btree (provincia);
...
--
-- Name: miur_adozioni_202627_anno_scolastico_codicescuola_annocorso_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX miur_adozioni_202627_anno_scolastico_codicescuola_annocorso_idx ON public.miur_adozioni_202627 USING btree (anno_scolastico, codicescuola, annocorso, sezioneanno, combinazione, codiceisbn, disciplina);


--
-- Name: miur_adozioni_202627_codicescuola_editore_annocorso_discipl_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX miur_adozioni_202627_codicescuola_editore_annocorso_discipl_idx ON public.miur_adozioni_202627 USING btree (codicescuola) INCLUDE (editore, annocorso, disciplina) WHERE ((tipogradoscuola)::text = 'EE'::text);


--
-- Name: miur_adozioni_202627_codicescuola_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX miur_adozioni_202627_codicescuola_idx ON public.miur_adozioni_202627 USING btree (codicescuola);


--
-- Name: miur_adozioni_202627_disciplina_annocorso_tipogradoscuola_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX miur_adozioni_202627_disciplina_annocorso_tipogradoscuola_idx ON public.miur_adozioni_202627 USING btree (disciplina, annocorso, tipogradoscuola);


--
-- Name: miur_scuole_202627_anno_scolastico_codice_scuola_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX miur_scuole_202627_anno_scolastico_codice_scuola_idx ON public.miur_scuole_202627 USING btree (anno_scolastico, codice_scuola);


--
-- Name: miur_scuole_202627_codice_scuola_regione_provincia_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX miur_scuole_202627_codice_scuola_regione_provincia_idx ON public.miur_scuole_202627 USING btree (codice_scuola) INCLUDE (regione, provincia);


--
-- Name: miur_scuole_202627_tipo_scuola_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX miur_scuole_202627_tipo_scuola_idx ON public.miur_scuole_202627 USING btree (tipo_scuola);
...
--
-- Name: miur_adozioni_202627_anno_scolastico_codicescuola_annocorso_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.index_miur_adozioni_on_classe ATTACH PARTITION public.miur_adozioni_202627_anno_scolastico_codicescuola_annocorso_idx;


--
-- Name: miur_adozioni_202627_codicescuola_editore_annocorso_discipl_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.idx_miur_adoz_ee ATTACH PARTITION public.miur_adozioni_202627_codicescuola_editore_annocorso_discipl_idx;


--
-- Name: miur_adozioni_202627_codicescuola_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.idx_miur_adozioni_codicescuola ATTACH PARTITION public.miur_adozioni_202627_codicescuola_idx;


--
-- Name: miur_adozioni_202627_disciplina_annocorso_tipogradoscuola_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.idx_miur_adozioni_disc_anno_tg ATTACH PARTITION public.miur_adozioni_202627_disciplina_annocorso_tipogradoscuola_idx;
...
--
-- Name: miur_scuole_202627_anno_scolastico_codice_scuola_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.index_miur_scuole_on_codice_scuola ATTACH PARTITION public.miur_scuole_202627_anno_scolastico_codice_scuola_idx;


--
-- Name: miur_scuole_202627_codice_scuola_regione_provincia_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.idx_miur_scuole_cod ATTACH PARTITION public.miur_scuole_202627_codice_scuola_regione_provincia_idx;
...
--
-- Name: miur_scuole_202627_tipo_scuola_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.idx_miur_scuole_tipo ATTACH PARTITION public.miur_scuole_202627_tipo_scuola_idx;
...
--
-- Name: adozioni_comunicate fk_rails_019539bd2f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.adozioni_comunicate
    ADD CONSTRAINT fk_rails_019539bd2f FOREIGN KEY (import_adozione_id) REFERENCES public.import_adozioni(id);


--
-- Name: old_adozioni fk_rails_059e13d2c8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.old_adozioni
    ADD CONSTRAINT fk_rails_059e13d2c8 FOREIGN KEY (import_scuola_id) REFERENCES public.import_scuole(id);
...
--
-- Name: adozioni fk_rails_192ecf53b8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.adozioni
    ADD CONSTRAINT fk_rails_192ecf53b8 FOREIGN KEY (import_adozione_id) REFERENCES public.import_adozioni(id);
